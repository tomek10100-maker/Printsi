    ...
    const content: Record<TabType, { title: string; subtitle: string; accent: string; steps: { icon: React.ReactNode; title: string; desc: string }[]; cta: { label: string; href: string } }> = {
        buyer: {
            ...
            steps: [
                ...
                { icon: <CheckCircle2 size={22} />, title: 'Pre-Shipment Photo Verification', desc: 'Before your parcel is dispatched, the seller uploads high-resolution verification photos of your finished 3D print directly into the order chat. Inspect the print quality and click "LOOKS GOOD! CONFIRM" to trigger shipping label generation.' },
        ...
        job: {
            ...
            steps: [
                ...
                { icon: <CheckCircle2 size={22} />, title: 'Print Quality Verification', desc: 'The printer uploads photos of the finished 3D print to the order chat for your review. Inspect print quality and approve before the shipping label is issued.' },
                { icon: <Truck size={22} />, title: 'Production & Shipping', desc: 'The printer produces your item using your 3D file. Once shipped, you\'ll be notified in the chat and can track delivery status.' },
