...
function RoleCard({ title, desc, active, onClick, disabled, badge }: any) {
    return (
        ...
        >
            {badge && (
                <span className="absolute top-3 right-3 text-[9px] font-black uppercase tracking-widest bg-amber-100 text-amber-800 px-2 py-0.5 rounded-full border border-amber-200 shadow-sm">
                    {badge}
                </span>
            )}
