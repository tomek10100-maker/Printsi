    ...
    const handleComplete = async () => {
        ...
        try {
            ...
            const { error } = await supabase.from('profiles').upsert({
                ...
                roles: roles.length > 0 ? roles : ['customer'], // Wyr├│wnanie min. 1 roli
                country: country, // Opcjonalnie do tabeli profiles je┼Ťli takowa kolumna istnieje
                updated_at: new Date(),
            });

            if (error) throw error;

            // Zapisz walut─Ö w context
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-gray-400 font-bold text-xs">Ôľ╝</div>
                                    </div>
                                </div>
